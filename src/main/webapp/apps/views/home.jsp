    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="/" class="navbar-brand p-0">
                <h1 class="m-0"><img src="img/logo-no-background.png" alt="" style="width: 250px; height: 50px;"></h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="/withdrawdetails"><i class="fa-solid fa-building-columns bank_logo" ></i></a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div>
                            <p><i class="fa-solid fa-wallet"></i>
                                My Wallet
                            </p>
                        </div>
                        <div class="button-container">
                            <a href="/deposit" class="action-button-deposit">
                                <i class="fa-solid fa-download"></i>
                                Deposit
                            </a>

                            <a href="/withdraw" class="action-button-withdraw">
                                <i class="fa-solid fa-arrow-up-from-bracket"></i>
                                Withdraw
                            </a>
                        </div>
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Digital pay Money</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Payment earn soulation</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Digital pay Money</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Payment Earn Soulation & Digital
                                Solution</h1>
                            <a href="/quote" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Free
                                Quote</a>
                            <a href="" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Contact
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Go Cashless With Digital Payment</h1>
                    </div>
                    <p class="mb-4">
                        <li><b>Embrace Cashless Convenience:</b> Shift to digital payments for a seamless and efficient
                            financial experience, eliminating the need for physical cash transactions.</li>
                        <li><b>Enhance Security, Go Cashless:</b> Opt for digital payments to prioritize security,
                            reducing risks associated with physical currency and embracing the convenience of a cashless
                            economy.</li>
                    </p>
                    ...
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">+0141 4084 422</h4>
                        </div>
                    </div>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                            src="https://media.istockphoto.com/id/1453969173/photo/businessman-using-tablet-on-global-business-network-for-online-banking-and-payment-for-online.webp?b=1&s=170667a&w=0&k=20&c=PtWnfqB8xm0HDM-i_txhUAxZ9Xu37uTsgOauDJsNoRc="
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Smartest Way to Make your Business and Payment</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="row g-5">
